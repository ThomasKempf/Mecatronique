...
#define PERIOD_US   200000 // Loop period in us

#define TREE_PROB   0.006 // Probability of a new tree in an empty cell
#define BURN_PROB   0.00001 // Probability of a tree burning spontaneously
