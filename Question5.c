...
#define PERIOD_US   300000 // Loop period in us
...
enum { empty = 0, tree = 1, fire = 2, cendre = 3};  // Possible state of each cell
const char *disp[] = {" ", "\033[32m@\033[m", "\033[07;31m@\033[m","\033[00;31m@\033[m"};    //ANSI escape codes for empty, tree and burning cell
